                  ...
                  {tools.length > 0 && (
                    <div>
                      ...
                      {tools.map((tc,j) => {
                        ...
                        // Show args context for dispatch and route
                        const argHint = name==='dispatchUnit' && tc.result?.unit?.name
                          ? ` — ${tc.result.unit.name}`
                          : name==='getRoute' && tc.result?.totalTimeMinutes
                          ? ` — ETA ${tc.result.totalTimeMinutes}min`
                          : name==='blockRoad' && tc.result?.edgeName
                          ? ` — ${tc.result.edgeName}`
                          : '';
                        return (
